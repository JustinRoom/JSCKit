...
package jsc.kit.component.baseui.camera2;
...
public class Camera2BasicFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        //
        mTextureView = new AutoFitTextureView(inflater.getContext());
        mTextureView.setId(R.id.jsc_id_texture_view);
        relativeLayout.addView(mTextureView, new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        //
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        params.addRule(RelativeLayout.BELOW, R.id.jsc_id_texture_view);
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        frameLayout.setBackgroundColor(0xcc4285f4);
        ...
        frameLayout.addView(button, params1);
