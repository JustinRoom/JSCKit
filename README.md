...
```
	dependencies {
	        compile 'com.github.JustinRoom:JSCKit:0.2.7'
	}
```
##### Maven: 
...
|:---:|:---|:---|
| 1  | [**DateTimePicker**](/DateTimePickerLibrary/src/main/java/jsc/lib/datetimepicker/widget/DateTimePicker.java) | [**日期选择器DateTimePicker**](https://www.jianshu.com/p/db19efcaa226) |
| 2  | [**CustomToast**](//src/main/java/jsc/kit/utils) | |

### About frame:

| index | Functionality | Article |
|:---:|:---|:---|
| 1  | [**APermissionCheckActivity**](//src/main/java/jsc/kit/baseui/APermissionCheckActivity.java) | [**简洁易用andrioid6.0+权限请求组件**](https://www.jianshu.com/p/47052d575f5b)|
| 2  | [**APhotoActivity**](//src/main/java/jsc/kit/baseui/APhotoActivity.java) | [**从相册选取图片，拍照、裁剪一篇就够了**](https://www.jianshu.com/p/bab57479bbad) |
